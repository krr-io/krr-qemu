...
#define RR_GFU_BEGIN 0xffffffff810313a0
...
#define PF_EXEC 0xffffffff817f3500 // info addr exc_page_fault
#define PF_EXEC_END 0xffffffff817f37a0 // b fault.c:1580 arch/x86/mm/fault.c:1463
#define RR_CFU_BEGIN 0xffffffff81031410
#define RR_RECORD_CFU 0xffffffff810314f0 // info addr rr_record_cfu
#define RR_GFU_NOCHECK1 0xffffffff817b6dde // b arch/x86/lib/getuser.S:127
#define RR_RECORD_GFU 0xffffffff817b6dc4 // b getuser.S:103
#define RR_GFU_NOCHECK4 0xffffffff817b6e1d // b getuser.S:162
#define RR_GFU_NOCHECK8 0xffffffff817b6e3e // b getuser.S:147
#define RR_GFU4 0xffffffff817b6d93 // b getuser.S:88
#define PF_ENTRY 0xffffffff81a00b40 // info addr asm_exc_page_fault
#define RR_PTE_CLEAR 0xffffffff810317b0 // info addr rr_record_pte_clear
#define RR_PTE_READ 0xffffffff81031820 // info addr rr_read_pte
#define RR_GFU_CALL_BEGIN 0xffffffff810346b0
#define RR_PTE_READ_ONCE 0xffffffff81031890

#define RR_IRET 0xffffffff81800eed // b arch/x86/entry/entry_64.S:702
#define RR_SYSRET 0xffffffff81800193 // b arch/x86/entry/entry_64.S:226
#define SYSCALL_ENTRY 0xffffffff81800000 // info addr entry_SYSCALL_64
#define SYSCALL_EXIT 0xffffffff817f3d60 // info addr syscall_exit_to_user_mode
...
#define IRQ_ENTRY 0xffffffff817f3c70 // info addr irqentry_enter
#define IRQ_EXIT 0xffffffff817f3dd0 // info addr irqentry_exit

#define LOCK_RELEASE 0 // info addr rr_record_release
#define RR_RECORD_SYSCALL 0xffffffff817f2d80 // info addr rr_record_syscall

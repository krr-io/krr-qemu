...
#define STRNCPY_FROM_USER 0xffffffff8146a950 // b lib/strncpy_from_user.c:42
#define STRNLEN_USER 0xffffffff8146aae0 // info addr strnlen_user
#define RANDOM_GEN 0xffffffff810316b0 // info addr rr_record_random
#define PF_EXEC 0xffffffff817f2760 // info addr exc_page_fault
#define PF_EXEC_END 0xffffffff817f2a00 // b fault.c:1580 arch/x86/mm/fault.c:1463
#define RR_CFU_BEGIN 0xffffffff81031790
#define RR_RECORD_CFU 0xffffffff81031870 // info addr rr_record_cfu
#define RR_GFU_NOCHECK1 0xffffffff817b5f6e // b arch/x86/lib/getuser.S:127
#define RR_RECORD_GFU 0xffffffff817b5f54 // b getuser.S:103
#define RR_GFU_NOCHECK4 0xffffffff817b5fad // b getuser.S:162
#define RR_GFU_NOCHECK8 0xffffffff817b5fce // b getuser.S:147
#define RR_GFU4 0xffffffff817b5f23 // b getuser.S:88
...
#define SYSCALL_EXIT 0xffffffff817f2fc0 // info addr syscall_exit_to_user_mode
...
#define IRQ_ENTRY 0xffffffff817f2ed0 // info addr irqentry_enter
#define IRQ_EXIT 0xffffffff817f3030 // info addr irqentry_exit

#define LOCK_RELEASE 0 // info addr rr_record_release
#define RR_RECORD_SYSCALL 0xffffffff817f1fe0 // info addr rr_record_syscall
